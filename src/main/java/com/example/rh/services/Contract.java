...
public class Contract extends AbstractVerticle {
   ...
   * @author : abdellah
   * <p>
   * this function is an event bus consumer handler that creates a contract
   * respecting the provided fields and returns a JsonObject containing the created contract
   * </p>
   */
  private void createContractHandler(Message<JsonObject> message) {
    try {
      ...
      JsonObject contract = new JsonObject()
        ...
        .put("date_creation", new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(new Date(System.currentTimeMillis())));
